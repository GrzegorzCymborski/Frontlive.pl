...
Znacznie ciekawiej wygląda modyfikowanie zmiennej. Tutaj, na prawdę, <Sparkles>ogranicza nas tylko nasz kreatywność.</Sparkles> Tym razem również korzystamy z `document.documentElement`, ale trochę w innym kontekście. Tutaj dostajemy się do obiektu style, a w nim do metody `setProperty`, w której możemy modyfikować naszą zmienną.
